    ...
    <div class="container relative max-w-2xl mx-auto bg-white shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5">
      ...
      <main>
        <div class="p-4 mx-auto prose md:px-6 prose-indigo sm:rounded-md">
          ...
          <ul>
            <li>Pinia store (fully typed Vuex store available in
          ...
          <p>
            ...
            <a href="https://gitlab.com/uninen/vue-cli-template">https://gitlab.com/uninen/vue-cli-template</a>. That's a
            real world example of proper coverage configuration that works automatically
          ...
          <p>
            ...
            <a href="https://github.com/evanw/esbuild/issues/184">
              code coverage being out of scope </a>. Vitest can be configured to produce code coverage as well but that
            only counts unit
            tests.
          </p>
